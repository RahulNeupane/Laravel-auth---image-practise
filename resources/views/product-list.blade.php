                ...
                <tbody>
                    ...
                    @foreach ($data as $prod)
                        <tr>
                            ...
                            <td><img src="images/{{ $prod->prodimage }}" alt=""
                                    style="width: 100px; height:100px;"></td>
                            <td class="pt-5"><a href="{{ url('edit-product/' . $prod->id) }}"
                                    class="btn btn-primary rounded-pill">Edit</a> <a
                                    href="{{ url('delete-product/' . $prod->id) }}"
