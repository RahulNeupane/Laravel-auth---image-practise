            ...
            <table class="table" style="margin-top: 20px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pt-5">{{$prod->prodprice}}</td>
                        <td class="pt-5">{{$prod->proddesp}}</td>
                        <td><img src="images/{{$prod->prodimage}}" alt="" style="width: 100px; height:100px;"></td>
                        <td class="pt-5"><a href="{{url('edit-product')}}" class="btn btn-primary rounded-pill">Edit</a> <a href="" class="btn btn-danger rounded-pill">Delete</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
